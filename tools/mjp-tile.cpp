...
public:
  ...
  //  cerr << "Please contact Prem to understand the arguments to be passed with the above options" << endl;
...
main(int argc, char *argv[]) {
  ...
  command.option("-o", "--output-dir <dir>", " ", TerrainBuild::setOutputDir);
  command.option("-f", "--output-format <format>", " ", TerrainBuild::setOutputFormat);
  command.option("-p", "--profile <profile>", " ", TerrainBuild::setProfile);
  command.option("-c", "--thread-count <count>", " ", TerrainBuild::setThreadCount);
  command.option("-t", "--tile-size <size>", " ", TerrainBuild::setTileSize);
  command.option("-s", "--start-zoom <zoom>", " ", TerrainBuild::setStartZoom);
  command.option("-e", "--end-zoom <zoom>", " ", TerrainBuild::setEndZoom);
  command.option("-r", "--resampling-method <algorithm>", " ", TerrainBuild::setResampleAlg);
  command.option("-n", "--creation-option <option>", " ", TerrainBuild::addCreationOption);
  command.option("-z", "--error-threshold <threshold>", " ", TerrainBuild::setErrorThreshold);
  command.option("-m", "--warp-memory <bytes>", " ", TerrainBuild::setWarpMemory);
  command.option("-R", "--resume", " ", TerrainBuild::setResume);
  command.option("-g", "--mesh-qfactor <factor>", " ", TerrainBuild::setMeshQualityFactor);
  command.option("-l", "--layer", " ", TerrainBuild::setMetadata);
  command.option("-C", "--cesium-friendly", " ", TerrainBuild::setCesiumFriendly);
  command.option("-N", "--vertex-normals", " ", TerrainBuild::setVertexNormals);
  command.option("-q", "--quiet", " ", TerrainBuild::setQuiet);
  command.option("-v", "--verbose", " ", TerrainBuild::setVerbose);
